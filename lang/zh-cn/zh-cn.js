...
UE.I18N['zh-cn'] = {
    'labelMap':{
        ...
        'mergecells':'合并多个单元格', 'deletetable':'删除表格', 'wordpaster':'粘贴Word图片','cleardoc':'清空文档','insertparagraphbeforetable':"表格前插入行",'insertcode':'代码语言','fontfamily':'字体', 'fontsize':'字号', 'paragraph':'段落格式', 'insertimage':'图片',
